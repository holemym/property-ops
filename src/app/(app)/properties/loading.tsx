...
// Loading fallback for the properties list. Mirrors the real layout — header, filter
// bar, and a four-column table — so the shell doesn't reflow when data arrives.
